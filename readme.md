...
- `\fe` preserves already-valid Unicode and decodes contiguous byte-like runs with replacement on invalid sequences. Symbol bytes map to the Windows Symbol private-use range and require a compatible loaded face; Johab and charset-based font linking are unsupported by design.
